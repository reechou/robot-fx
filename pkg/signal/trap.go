			...
			go func(sig os.Signal) {
				...
				case os.Interrupt, syscall.SIGTERM:
					if atomic.LoadUint32(&interruptCount) < 3 {
						...
						logrus.Infof("Forcing server daemon shutdown without cleanup; 3 interrupts received")
					}
				case syscall.SIGQUIT:
					DumpStacks()
					logrus.Infof("Forcing server daemon shutdown without cleanup on SIGQUIT")
				}
